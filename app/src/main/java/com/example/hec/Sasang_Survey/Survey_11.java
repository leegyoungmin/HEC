...
public class Survey_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sasang_activity_survey_11);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                result.put("answer11",value);
                Intent intent = new Intent(getApplicationContext(),Survey_12.class);
