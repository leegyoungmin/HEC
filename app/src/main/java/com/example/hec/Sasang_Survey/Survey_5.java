...
public class Survey_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sasang_activity_survey_5);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                result.put("answer5",value);
                Intent intent = new Intent(getApplicationContext(),Survey_6.class);
