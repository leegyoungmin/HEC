...
public class Survey_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sasang_activity_survey_12);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                result.put("answer12",value);
                Intent intent = new Intent(getApplicationContext(),Survey_13.class);
