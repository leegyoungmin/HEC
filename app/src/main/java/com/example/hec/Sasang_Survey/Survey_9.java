...
public class Survey_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sasang_activity_survey_9);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                result.put("answer9",value);
                Intent intent = new Intent(getApplicationContext(),Survey_10.class);
