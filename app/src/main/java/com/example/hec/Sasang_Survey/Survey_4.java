...
public class Survey_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sasang_activity_survey_4);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                result.put("answer4",value);
                Intent intent = new Intent(getApplicationContext(),Survey_5.class);
