...
public class inbody_survey10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inbody_activity_survey10);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                inbody_result.put("answer10",value);

                Intent intent = new Intent(getApplicationContext(), inbody_survey11.class);
