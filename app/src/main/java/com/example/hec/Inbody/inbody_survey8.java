...
public class inbody_survey8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inbody_activity_survey8);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                inbody_result.put("answer8",value);

                Intent intent = new Intent(getApplicationContext(), inbody_survey9.class);
