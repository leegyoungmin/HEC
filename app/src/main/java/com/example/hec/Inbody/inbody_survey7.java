...
public class inbody_survey7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inbody_activity_survey7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                inbody_result.put("answer7",value);

                Intent intent = new Intent(getApplicationContext(), inbody_survey8.class);
