...
public class inbody_survey6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inbody_activity_survey6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                inbody_result.put("answer6",value);

                Intent intent = new Intent(getApplicationContext(), inbody_survey7.class);
